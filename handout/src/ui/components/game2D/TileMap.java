...
public class TileMap 
{
	 ...
	 */
	public void draw(java.awt.Graphics2D g, int xoff, int yoff)
	{
		if (g == null) return;
	
		Image img=null;
		java.awt.Rectangle rect = (java.awt.Rectangle)g.getClip();
		int xc,yc;
	 ...
	 */
	public void drawBorder(java.awt.Graphics2D g, int xoff, int yoff, java.awt.Color colour)
	{
		if (g == null) return;
