...
public class Animation {
    ...
    // Transition metadata for state-based animations
    public String fromState = null;			// Source state for transitions
    public String toState = null;			// Destination state for transitions
    public String transitionType = null;	// Type of transition (SLIDE, FADE, BOUNCE, etc)
